			...
			<div class="index-left-div">
				<div class="index-menu-list">
					<div class="index-amenu">
						<div class="index-item-menu"   @click="gotoIframePage"  :data-url="'/home'">
					...
					<div class="index-amenu">
						<div class="index-item-menu"   @click="gotoIframePage"  :data-url="'/admin/fix/list'">
							<div class="index-item-menu-icon"></div>
							<div class="index-item-menu-span">
								维修员管理
							</div>
					...
					<div class="index-amenu">
						<div class="index-item-menu"   @click="gotoIframePage"  :data-url="'/admin/user/list'">
							<div class="index-item-menu-icon"></div>
							<div class="index-item-menu-span">
								用户管理
							</div>
					...
					<div class="index-amenu">
						<div class="index-item-menu"   @click="gotoIframePage"  :data-url="'/admin/depart/list'">
							<div class="index-item-menu-icon"></div>
							<div class="index-item-menu-span">
								部门管理
							</div>
					...
					<div class="index-amenu">
						<div class="index-item-menu"   @click="gotoIframePage"  :data-url="'/admin/bgqy/list'">
							<div class="index-item-menu-icon"></div>
							<div class="index-item-menu-span">
								办公区域
							</div>
					...
					<div class="index-amenu">
						<div class="index-item-menu"   @click="gotoIframePage"  :data-url="'/admin/bg_service/list'">
							<div class="index-item-menu-icon"></div>
							<div class="index-item-menu-span">
								办公设备
							</div>
					...
					<div class="index-amenu">
						<div class="index-item-menu"   @click="gotoIframePage"  :data-url="'/admin/bx_log/list'">
							<div class="index-item-menu-icon"></div>
							<div class="index-item-menu-span">
								报修管理
							</div>
					...
					<div class="index-amenu">
						<div class="index-item-menu"   @click="gotoIframePage"  :data-url="'/admin/zsk/list'">
							<div class="index-item-menu-icon"></div>
							<div class="index-item-menu-span">
								知识库管理
							</div>
					...
					<div class="index-amenu">
						<div class="index-item-menu"   @click="gotoIframePage"  :data-url="'/admin/pj_req/list'">
							<div class="index-item-menu-icon"></div>
							<div class="index-item-menu-span">
								配件申请管理
							</div>
					...
					<div class="index-amenu">
						<div class="index-item-menu"   @click="gotoIframePage"  :data-url="'/admin/eval_log/list'">
							<div class="index-item-menu-icon"></div>
							<div class="index-item-menu-span">
								评价管理
							</div>
					...
					<div class="index-amenu">
						<div class="index-item-menu"   @click="gotoIframePage"  :data-url="'/admin/xt_notice/list'">
							<div class="index-item-menu-icon"></div>
							<div class="index-item-menu-span">
								系统公告
							</div>
	...
	methods:{
		...
		checkIsLogin(){
			...
			$.ajax({
				...
				success : function(result) {
					if(result.code==0||result.login.loginType!=1) {
						that.goToPageJS('/sys_login','');
					}
				}
			});
